...
const doApplyTodosIndexRequesting = state => ({
  ...state,
  requesting: true,
});
...
const doApplyTodoPostRequesting = state => ({
  ...state,
  requesting: true,
});
...
const doApplyTodoEditRequesting = state => ({
  ...state,
  requesting: true,
});
...
const doApplyTodoReminderPostRequesting = state => ({
  ...state,
  requesting: true,
});
...
const doApplyTodosDeleteRequesting = state => ({
  ...state,
  requesting: true,
});
